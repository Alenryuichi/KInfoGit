        ...
        <div className="max-w-4xl mx-auto px-5 sm:px-6 pt-32 pb-32 relative z-10">
          ...
          >
            <div className="flex items-center gap-4">
                ...
                <Link href="/code/specs/" className="group inline-flex items-center gap-3 border border-white/20 text-white px-6 py-2.5 rounded-full hover:border-white/50 hover:bg-white/5 transition-colors font-medium text-sm">
            ...
            <div className="text-[10px] text-gray-500 font-mono uppercase tracking-widest">
                Arena · SWE-bench · LiveCodeBench · Spec Ecosystem
            </div>
          </motion.div>
