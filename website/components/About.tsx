        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <div id="contact" className="flex items-center gap-4 scroll-mt-24">
                <a
            ...
            <div className="relative">
              ...
              <div className="relative">
                ...
                {/* Image Container */}
                <div className="relative bg-gray-100 dark:bg-gray-800 rounded-3xl p-2 shadow-2xl">
                ...
                {/* Travel Tag */}
                <div className="absolute -bottom-4 -right-4 bg-gray-100 dark:bg-gray-800 rounded-full px-6 py-3 shadow-lg border border-gray-200 dark:border-gray-700">
