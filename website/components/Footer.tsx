          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="flex space-x-3">
                <a
                  href="mailto:miaojsi@outlook.com"
                  className="p-2 bg-gray-800 hover:bg-gray-700 rounded-lg transition-colors hover:text-red-400"
                  aria-label="Email"
                >
                ...
                <a
                  href="#"
                  className="p-2 bg-gray-800 hover:bg-gray-700 rounded-lg transition-colors hover:text-gray-100"
                  aria-label="GitHub"
                >
                ...
                <a
                  href="#"
                  className="p-2 bg-gray-800 hover:bg-gray-700 rounded-lg transition-colors hover:text-blue-400"
                  aria-label="LinkedIn"
                >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between">
              ...
              <div className="flex items-center text-sm text-gray-400">
                ...
                <div className="flex items-center ml-2 space-x-2">
                  <span className="px-2 py-1 bg-gray-800 rounded text-xs">Next.js</span>
