...
readTime: "7 min read"
featured: false
image: "/blog/covers/2026-03-01-context-experience-商品发放-钱包选择问题-md.png"
excerpt: "本文介绍了一种基于AI工程工具架构的知识复合实践，通过Command、Agent、Skill三层架构实现经验的持续沉淀与智能复用。核心在于将知识编码到工具中，利用experience-index在正确时机自动检索并推送相关规则，从而显著提升重复性任务的效率，体现了将复杂性内化于智能代理而非用户界面的设计理念。"
---
