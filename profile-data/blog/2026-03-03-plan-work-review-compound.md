...
readTime: "3 min read"
featured: false
image: "/blog/covers/2026-03-03-plan-work-review-compound.png"
excerpt: "本文介绍了Compound Engineering Plugin如何通过Plan→Work→Review→Compound的闭环工作流，将AI从被动工具转变为能够持续学习和沉淀知识的开发伙伴。文章阐述了知识复合的典型场景和实现机制，展示了通过系统化记录错误、封装流程和积累经验，使开发效率实现复利增长的具体案例。"
---
