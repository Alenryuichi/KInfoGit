...
readTime: "7 min read"
featured: false
image: "/blog/covers/2026-03-22-context-experience-商品发放-钱包选择问题-md.png"
excerpt: "本文介绍了一种基于AI工程工具架构的知识复合实践，通过设计包含Command、Agent和Skill的层级系统，实现开发经验的持续沉淀与智能复用。核心在于利用experience-index在正确时机自动检索历史规则，显著提升重复性任务（如支付需求开发）的效率，并阐述了与传统文档管理的本质区别及其对长期任务工程设计的启示。"
---
