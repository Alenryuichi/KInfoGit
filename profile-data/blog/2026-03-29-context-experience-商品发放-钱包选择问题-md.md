...
readTime: "7 min read"
featured: false
image: "/blog/covers/2026-03-29-context-experience-商品发放-钱包选择问题-md.png"
excerpt: "本文介绍了一种基于AI工程工具架构的知识复合实践。通过设计包含Command、Agent、Skill和experience-index的架构，实现了经验的持续沉淀与智能检索。文章阐述了知识复合的两条路径——经验沉淀与经验检索，并通过支付需求的复利效应示例，展示了该实践如何显著提升效率。最后，文章讨论了该理念对长期任务工程设计的启示，强调入口极简化和Skill化能力封装的设计思路。"
---
