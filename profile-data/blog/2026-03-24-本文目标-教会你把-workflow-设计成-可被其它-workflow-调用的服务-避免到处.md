...
readTime: "4 min read"
featured: false
image: "/blog/covers/2026-03-24-本文目标-教会你把-workflow-设计成-可被其它-workflow-调用的服务-避免到处.png"
excerpt: "本文介绍了如何将 workflow 设计成可被其他 workflow 调用的服务，以避免重复逻辑。核心方法包括：通过定义多 mode 实现功能路由，使用 <invoke-workflow> 和 <param> 进行参数传递，以及利用 template-output 返回结构化数据供调用方使用。"
---
