...
date: "2026-03-06"
tags: ["workflow","自动化","代码复用","服务化设计","开发效率"]
category: "Engineering"
readTime: "4 min read"
featured: false
image: "/blog/covers/2026-03-06-本文目标-教会你把-workflow-设计成-可被其它-workflow-调用的服务-避免到处.png"
excerpt: "本文介绍了如何将 workflow 设计成可复用的服务，避免逻辑重复。核心方法是创建“服务型 workflow”，通过 mode 参数路由不同功能，使用 <invoke-workflow> 和 <param> 进行调用与传参，并利用 template-output 返回结构化数据供调用方使用，从而提升自动化流程的模块化和维护性。"
---
